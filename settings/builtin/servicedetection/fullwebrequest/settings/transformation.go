...
type Transformation struct {
	...
	TransformationType TransformationType `json:"transformationType"`    // Possible Values: `REMOVE_NUMBERS`, `REMOVE_IBANS`, `SPLIT_SELECT`, `AFTER`, `REPLACE_BETWEEN`, `REMOVE_CREDIT_CARDS`, `REMOVE_IPS`, `TAKE_SEGMENTS`, `BETWEEN`, `BEFORE`
}
...
func (me *Transformation) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"transformation_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `REMOVE_NUMBERS`, `REMOVE_IBANS`, `SPLIT_SELECT`, `AFTER`, `REPLACE_BETWEEN`, `REMOVE_CREDIT_CARDS`, `REMOVE_IPS`, `TAKE_SEGMENTS`, `BETWEEN`, `BEFORE`",
			Required:    true,
		},
	}
}
