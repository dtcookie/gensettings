...
type Transformation struct {
	...
	TransformationType TransformationType `json:"transformationType"`    // Possible Values: `REMOVE_CREDIT_CARDS`, `TAKE_SEGMENTS`, `BEFORE`, `AFTER`, `SPLIT_SELECT`, `REMOVE_IBANS`, `BETWEEN`, `REPLACE_BETWEEN`, `REMOVE_NUMBERS`, `REMOVE_IPS`
}
...
func (me *Transformation) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"transformation_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `REMOVE_CREDIT_CARDS`, `TAKE_SEGMENTS`, `BEFORE`, `AFTER`, `SPLIT_SELECT`, `REMOVE_IBANS`, `BETWEEN`, `REPLACE_BETWEEN`, `REMOVE_NUMBERS`, `REMOVE_IPS`",
			Required:    true,
		},
	}
}
