...
type Settings struct {
	...
	Issuetrackersystem IssueTrackerSystem `json:"issuetrackersystem"` // Possible Values: `SERVICENOW`, `JIRA_ON_PREMISE`, `JIRA_CLOUD`, `JIRA`, `GITHUB`, `GITLAB`
...
func (me *Settings) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"issuetrackersystem": {
			Type:        schema.TypeString,
			Description: "Possible Values: `SERVICENOW`, `JIRA_ON_PREMISE`, `JIRA_CLOUD`, `JIRA`, `GITHUB`, `GITLAB`",
			Required:    true,
		},
		"password": {
			Type:        schema.TypeString,
