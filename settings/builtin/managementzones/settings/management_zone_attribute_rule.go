...
type ManagementZoneAttributeRule struct {
	...
	EntityType                                 ManagementZoneMeType `json:"entityType"`                                           // Possible Values: `ENTERPRISE_APPLICATION`, `AZURE`, `KUBERNETES_SERVICE`, `OPENSTACK_ACCOUNT`, `ESXI_HOST`, `HOST_GROUP`, `SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION`, `AWS_AUTO_SCALING_GROUP`, `MOBILE_APPLICATION`, `HTTP_MONITOR`, `QUEUE`, `CLOUD_FOUNDRY_FOUNDATION`, `BROWSER_MONITOR`, `EXTERNAL_MONITOR`, `AWS_APPLICATION_LOAD_BALANCER`, `HOST`, `CUSTOM_DEVICE_GROUP`, `AWS_RELATIONAL_DATABASE_SERVICE`, `APPMON_SERVER`, `DATA_CENTER_SERVICE`, `CLOUD_APPLICATION_NAMESPACE`, `AWS_ACCOUNT`, `KUBERNETES_CLUSTER`, `WEB_APPLICATION`, `APPMON_SYSTEM_PROFILE`, `PROCESS_GROUP`, `CUSTOM_DEVICE`, `AWS_NETWORK_LOAD_BALANCER`, `CUSTOM_APPLICATION`
...
func (me *ManagementZoneAttributeRule) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"entity_type": {
			...
			Description: "Possible Values: `ENTERPRISE_APPLICATION`, `AZURE`, `KUBERNETES_SERVICE`, `OPENSTACK_ACCOUNT`, `ESXI_HOST`, `HOST_GROUP`, `SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION`, `AWS_AUTO_SCALING_GROUP`, `MOBILE_APPLICATION`, `HTTP_MONITOR`, `QUEUE`, `CLOUD_FOUNDRY_FOUNDATION`, `BROWSER_MONITOR`, `EXTERNAL_MONITOR`, `AWS_APPLICATION_LOAD_BALANCER`, `HOST`, `CUSTOM_DEVICE_GROUP`, `AWS_RELATIONAL_DATABASE_SERVICE`, `APPMON_SERVER`, `DATA_CENTER_SERVICE`, `CLOUD_APPLICATION_NAMESPACE`, `AWS_ACCOUNT`, `KUBERNETES_CLUSTER`, `WEB_APPLICATION`, `APPMON_SYSTEM_PROFILE`, `PROCESS_GROUP`, `CUSTOM_DEVICE`, `AWS_NETWORK_LOAD_BALANCER`, `CUSTOM_APPLICATION`",
			Required:    true,
		},
