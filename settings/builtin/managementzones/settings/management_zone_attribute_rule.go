...
type ManagementZoneAttributeRule struct {
	...
	EntityType                                 ManagementZoneMeType `json:"entityType"`                                           // Possible Values: `QUEUE`, `AWS_APPLICATION_LOAD_BALANCER`, `CUSTOM_APPLICATION`, `APPMON_SERVER`, `KUBERNETES_SERVICE`, `AZURE`, `ESXI_HOST`, `SERVICE`, `EXTERNAL_MONITOR`, `HOST`, `HOST_GROUP`, `MOBILE_APPLICATION`, `CLOUD_FOUNDRY_FOUNDATION`, `CLOUD_APPLICATION_NAMESPACE`, `AWS_ACCOUNT`, `CUSTOM_DEVICE`, `BROWSER_MONITOR`, `AWS_RELATIONAL_DATABASE_SERVICE`, `OPENSTACK_ACCOUNT`, `PROCESS_GROUP`, `AWS_NETWORK_LOAD_BALANCER`, `ENTERPRISE_APPLICATION`, `CUSTOM_DEVICE_GROUP`, `APPMON_SYSTEM_PROFILE`, `AWS_AUTO_SCALING_GROUP`, `DATA_CENTER_SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION`, `KUBERNETES_CLUSTER`, `WEB_APPLICATION`, `HTTP_MONITOR`
...
func (me *ManagementZoneAttributeRule) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"entity_type": {
			...
			Description: "Possible Values: `QUEUE`, `AWS_APPLICATION_LOAD_BALANCER`, `CUSTOM_APPLICATION`, `APPMON_SERVER`, `KUBERNETES_SERVICE`, `AZURE`, `ESXI_HOST`, `SERVICE`, `EXTERNAL_MONITOR`, `HOST`, `HOST_GROUP`, `MOBILE_APPLICATION`, `CLOUD_FOUNDRY_FOUNDATION`, `CLOUD_APPLICATION_NAMESPACE`, `AWS_ACCOUNT`, `CUSTOM_DEVICE`, `BROWSER_MONITOR`, `AWS_RELATIONAL_DATABASE_SERVICE`, `OPENSTACK_ACCOUNT`, `PROCESS_GROUP`, `AWS_NETWORK_LOAD_BALANCER`, `ENTERPRISE_APPLICATION`, `CUSTOM_DEVICE_GROUP`, `APPMON_SYSTEM_PROFILE`, `AWS_AUTO_SCALING_GROUP`, `DATA_CENTER_SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION`, `KUBERNETES_CLUSTER`, `WEB_APPLICATION`, `HTTP_MONITOR`",
			Required:    true,
		},
