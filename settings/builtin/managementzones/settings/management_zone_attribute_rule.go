...
type ManagementZoneAttributeRule struct {
	...
	EntityType                                 ManagementZoneMeType `json:"entityType"`                                           // Possible Values: `AWS_RELATIONAL_DATABASE_SERVICE`, `AZURE`, `AWS_APPLICATION_LOAD_BALANCER`, `KUBERNETES_CLUSTER`, `QUEUE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION_NAMESPACE`, `EXTERNAL_MONITOR`, `ENTERPRISE_APPLICATION`, `SERVICE`, `MOBILE_APPLICATION`, `AWS_NETWORK_LOAD_BALANCER`, `CLOUD_FOUNDRY_FOUNDATION`, `AWS_AUTO_SCALING_GROUP`, `DATA_CENTER_SERVICE`, `APPMON_SYSTEM_PROFILE`, `HOST_GROUP`, `PROCESS_GROUP`, `APPMON_SERVER`, `CUSTOM_DEVICE`, `OPENSTACK_ACCOUNT`, `CUSTOM_APPLICATION`, `CUSTOM_DEVICE_GROUP`, `KUBERNETES_SERVICE`, `AWS_ACCOUNT`, `HTTP_MONITOR`, `CLOUD_APPLICATION`, `WEB_APPLICATION`, `BROWSER_MONITOR`, `ESXI_HOST`, `HOST`
...
func (me *ManagementZoneAttributeRule) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"entity_type": {
			...
			Description: "Possible Values: `AWS_RELATIONAL_DATABASE_SERVICE`, `AZURE`, `AWS_APPLICATION_LOAD_BALANCER`, `KUBERNETES_CLUSTER`, `QUEUE`, `AWS_CLASSIC_LOAD_BALANCER`, `CLOUD_APPLICATION_NAMESPACE`, `EXTERNAL_MONITOR`, `ENTERPRISE_APPLICATION`, `SERVICE`, `MOBILE_APPLICATION`, `AWS_NETWORK_LOAD_BALANCER`, `CLOUD_FOUNDRY_FOUNDATION`, `AWS_AUTO_SCALING_GROUP`, `DATA_CENTER_SERVICE`, `APPMON_SYSTEM_PROFILE`, `HOST_GROUP`, `PROCESS_GROUP`, `APPMON_SERVER`, `CUSTOM_DEVICE`, `OPENSTACK_ACCOUNT`, `CUSTOM_APPLICATION`, `CUSTOM_DEVICE_GROUP`, `KUBERNETES_SERVICE`, `AWS_ACCOUNT`, `HTTP_MONITOR`, `CLOUD_APPLICATION`, `WEB_APPLICATION`, `BROWSER_MONITOR`, `ESXI_HOST`, `HOST`",
			Required:    true,
		},
