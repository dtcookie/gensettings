...
type ManagementZoneAttributeRule struct {
	...
	EntityType                                 ManagementZoneMeType `json:"entityType"`                                           // Possible Values: `KUBERNETES_CLUSTER`, `PROCESS_GROUP`, `CUSTOM_DEVICE_GROUP`, `AZURE`, `HOST`, `ESXI_HOST`, `HTTP_MONITOR`, `MOBILE_APPLICATION`, `OPENSTACK_ACCOUNT`, `AWS_ACCOUNT`, `AWS_NETWORK_LOAD_BALANCER`, `CLOUD_APPLICATION_NAMESPACE`, `APPMON_SYSTEM_PROFILE`, `CLOUD_APPLICATION`, `AWS_RELATIONAL_DATABASE_SERVICE`, `EXTERNAL_MONITOR`, `ENTERPRISE_APPLICATION`, `APPMON_SERVER`, `HOST_GROUP`, `AWS_AUTO_SCALING_GROUP`, `KUBERNETES_SERVICE`, `WEB_APPLICATION`, `AWS_APPLICATION_LOAD_BALANCER`, `QUEUE`, `CUSTOM_DEVICE`, `CUSTOM_APPLICATION`, `BROWSER_MONITOR`, `DATA_CENTER_SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `SERVICE`, `CLOUD_FOUNDRY_FOUNDATION`
...
func (me *ManagementZoneAttributeRule) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"entity_type": {
			...
			Description: "Possible Values: `KUBERNETES_CLUSTER`, `PROCESS_GROUP`, `CUSTOM_DEVICE_GROUP`, `AZURE`, `HOST`, `ESXI_HOST`, `HTTP_MONITOR`, `MOBILE_APPLICATION`, `OPENSTACK_ACCOUNT`, `AWS_ACCOUNT`, `AWS_NETWORK_LOAD_BALANCER`, `CLOUD_APPLICATION_NAMESPACE`, `APPMON_SYSTEM_PROFILE`, `CLOUD_APPLICATION`, `AWS_RELATIONAL_DATABASE_SERVICE`, `EXTERNAL_MONITOR`, `ENTERPRISE_APPLICATION`, `APPMON_SERVER`, `HOST_GROUP`, `AWS_AUTO_SCALING_GROUP`, `KUBERNETES_SERVICE`, `WEB_APPLICATION`, `AWS_APPLICATION_LOAD_BALANCER`, `QUEUE`, `CUSTOM_DEVICE`, `CUSTOM_APPLICATION`, `BROWSER_MONITOR`, `DATA_CENTER_SERVICE`, `AWS_CLASSIC_LOAD_BALANCER`, `SERVICE`, `CLOUD_FOUNDRY_FOUNDATION`",
			Required:    true,
		},
