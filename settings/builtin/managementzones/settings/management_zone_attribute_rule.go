...
type ManagementZoneAttributeRule struct {
	...
	EntityType                                 ManagementZoneMeType `json:"entityType"`                                           // Possible Values: `QUEUE`, `APPMON_SERVER`, `AWS_CLASSIC_LOAD_BALANCER`, `EXTERNAL_MONITOR`, `AWS_ACCOUNT`, `OPENSTACK_ACCOUNT`, `CLOUD_FOUNDRY_FOUNDATION`, `HOST_GROUP`, `CLOUD_APPLICATION_NAMESPACE`, `ENTERPRISE_APPLICATION`, `BROWSER_MONITOR`, `APPMON_SYSTEM_PROFILE`, `CUSTOM_APPLICATION`, `CUSTOM_DEVICE`, `AWS_RELATIONAL_DATABASE_SERVICE`, `MOBILE_APPLICATION`, `AWS_APPLICATION_LOAD_BALANCER`, `PROCESS_GROUP`, `ESXI_HOST`, `AWS_NETWORK_LOAD_BALANCER`, `CUSTOM_DEVICE_GROUP`, `KUBERNETES_CLUSTER`, `CLOUD_APPLICATION`, `AWS_AUTO_SCALING_GROUP`, `HOST`, `HTTP_MONITOR`, `DATA_CENTER_SERVICE`, `SERVICE`, `WEB_APPLICATION`, `KUBERNETES_SERVICE`, `AZURE`
