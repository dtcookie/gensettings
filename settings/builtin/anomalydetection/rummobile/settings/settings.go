...
type Settings struct {
	...
	Scope              string              `json:"-" scope:"scope"`    // The scope of this setting (DEVICE_APPLICATION_METHOD MOBILE_APPLICATION environment)
...
func (me *Settings) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"scope": {
			...
			Description: "The scope of this setting (DEVICE_APPLICATION_METHOD MOBILE_APPLICATION environment)",
			Required:    true,
		},
		"slow_user_actions": {
			Type:        schema.TypeList,
