...
func (me *MemoryRequestsQuotaSaturation) HandlePreconditions() error {
	// ---- Configuration *MemoryRequestsQuotaSaturationConfig -> {"expectedValue":true,"property":"enabled","type":"EQUALS"}
	return nil
}
