...
func (me *CpuLimitsQuotaSaturation) HandlePreconditions() error {
	// ---- Configuration *CpuLimitsQuotaSaturationConfig -> {"expectedValue":true,"property":"enabled","type":"EQUALS"}
	return nil
}
