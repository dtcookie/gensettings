...
type DiskNameFilter struct {
	Operator DiskNameFilterOperator `json:"operator"` // Possible Values: `CONTAINS`, `DOES_NOT_CONTAIN`, `EQUALS`, `DOES_NOT_EQUAL`, `STARTS_WITH`, `DOES_NOT_START_WITH`
...
func (me *DiskNameFilter) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"operator": {
			...
			Description: "Possible Values: `CONTAINS`, `DOES_NOT_CONTAIN`, `EQUALS`, `DOES_NOT_EQUAL`, `STARTS_WITH`, `DOES_NOT_START_WITH`",
			Required:    true,
		},
		"value": {
			Type:        schema.TypeString,
