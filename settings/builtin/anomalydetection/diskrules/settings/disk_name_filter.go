...
type DiskNameFilter struct {
	Operator DiskNameFilterOperator `json:"operator"` // Possible Values: `EQUALS`, `DOES_NOT_EQUAL`, `STARTS_WITH`, `DOES_NOT_START_WITH`, `CONTAINS`, `DOES_NOT_CONTAIN`
...
func (me *DiskNameFilter) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"operator": {
			...
			Description: "Possible Values: `EQUALS`, `DOES_NOT_EQUAL`, `STARTS_WITH`, `DOES_NOT_START_WITH`, `CONTAINS`, `DOES_NOT_CONTAIN`",
			Required:    true,
		},
		"value": {
			Type:        schema.TypeString,
