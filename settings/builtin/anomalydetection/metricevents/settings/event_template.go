...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `CUSTOM_DEPLOYMENT`, `SLOWDOWN`, `MARKED_FOR_TERMINATION`, `AVAILABILITY`, `INFO`, `CUSTOM_ALERT`, `CUSTOM_ANNOTATION`, `ERROR`, `RESOURCE`, `CUSTOM_CONFIGURATION`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `CUSTOM_DEPLOYMENT`, `SLOWDOWN`, `MARKED_FOR_TERMINATION`, `AVAILABILITY`, `INFO`, `CUSTOM_ALERT`, `CUSTOM_ANNOTATION`, `ERROR`, `RESOURCE`, `CUSTOM_CONFIGURATION`",
			Required:    true,
		},
		"metadata": {
