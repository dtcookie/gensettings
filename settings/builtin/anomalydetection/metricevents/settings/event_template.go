...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `AVAILABILITY`, `CUSTOM_DEPLOYMENT`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `MARKED_FOR_TERMINATION`, `INFO`, `CUSTOM_ANNOTATION`, `ERROR`, `RESOURCE`, `CUSTOM_ALERT`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `AVAILABILITY`, `CUSTOM_DEPLOYMENT`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `MARKED_FOR_TERMINATION`, `INFO`, `CUSTOM_ANNOTATION`, `ERROR`, `RESOURCE`, `CUSTOM_ALERT`",
			Required:    true,
		},
		"metadata": {
