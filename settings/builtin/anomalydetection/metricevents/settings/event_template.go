...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `CUSTOM_ANNOTATION`, `RESOURCE`, `AVAILABILITY`, `CUSTOM_ALERT`, `INFO`, `ERROR`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `CUSTOM_DEPLOYMENT`, `MARKED_FOR_TERMINATION`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `CUSTOM_ANNOTATION`, `RESOURCE`, `AVAILABILITY`, `CUSTOM_ALERT`, `INFO`, `ERROR`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `CUSTOM_DEPLOYMENT`, `MARKED_FOR_TERMINATION`",
			Required:    true,
		},
		"metadata": {
