...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `MARKED_FOR_TERMINATION`, `CUSTOM_DEPLOYMENT`, `AVAILABILITY`, `RESOURCE`, `CUSTOM_ANNOTATION`, `ERROR`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `INFO`, `CUSTOM_ALERT`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `MARKED_FOR_TERMINATION`, `CUSTOM_DEPLOYMENT`, `AVAILABILITY`, `RESOURCE`, `CUSTOM_ANNOTATION`, `ERROR`, `SLOWDOWN`, `CUSTOM_CONFIGURATION`, `INFO`, `CUSTOM_ALERT`",
			Required:    true,
		},
		"metadata": {
