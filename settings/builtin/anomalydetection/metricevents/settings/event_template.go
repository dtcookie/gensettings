...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `CUSTOM_CONFIGURATION`, `AVAILABILITY`, `SLOWDOWN`, `RESOURCE`, `CUSTOM_DEPLOYMENT`, `MARKED_FOR_TERMINATION`, `ERROR`, `CUSTOM_ALERT`, `CUSTOM_ANNOTATION`, `INFO`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `CUSTOM_CONFIGURATION`, `AVAILABILITY`, `SLOWDOWN`, `RESOURCE`, `CUSTOM_DEPLOYMENT`, `MARKED_FOR_TERMINATION`, `ERROR`, `CUSTOM_ALERT`, `CUSTOM_ANNOTATION`, `INFO`",
			Required:    true,
		},
		"metadata": {
