...
type ModelProperties struct {
	AlertCondition    AlertCondition `json:"alertCondition"`              // Possible Values: `OUTSIDE`, `ABOVE`, `BELOW`
	...
	Type              ModelType      `json:"type"`                        // Possible Values: `STATIC_THRESHOLD`, `AUTO_ADAPTIVE_THRESHOLD`, `SEASONAL_BASELINE`
...
func (me *ModelProperties) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"alert_condition": {
			...
			Description: "Possible Values: `OUTSIDE`, `ABOVE`, `BELOW`",
			Required:    true,
		},
		"alert_on_no_data": {
		...
		"type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `STATIC_THRESHOLD`, `AUTO_ADAPTIVE_THRESHOLD`, `SEASONAL_BASELINE`",
			Required:    true,
		},
		"violating_samples": {
			Type:        schema.TypeInt,
