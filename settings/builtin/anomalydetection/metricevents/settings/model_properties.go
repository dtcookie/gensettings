...
type ModelProperties struct {
	...
	Type              ModelType      `json:"type"`                        // Possible Values: `SEASONAL_BASELINE`, `STATIC_THRESHOLD`, `AUTO_ADAPTIVE_THRESHOLD`
...
func (me *ModelProperties) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `SEASONAL_BASELINE`, `STATIC_THRESHOLD`, `AUTO_ADAPTIVE_THRESHOLD`",
			Required:    true,
		},
		"violating_samples": {
			Type:        schema.TypeInt,
