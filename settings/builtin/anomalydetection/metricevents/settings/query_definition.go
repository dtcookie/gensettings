...
type QueryDefinition struct {
	Aggregation     *Aggregation      `json:"aggregation,omitempty"`     // Possible Values: `VALUE`, `MEDIAN`, `PERCENTILE90`, `MIN`, `MAX`, `SUM`, `COUNT`, `AVG`
...
func (me *QueryDefinition) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"aggregation": {
			...
			Description: "Possible Values: `VALUE`, `MEDIAN`, `PERCENTILE90`, `MIN`, `MAX`, `SUM`, `COUNT`, `AVG`",
			Optional:    true,
		},
		"dimension_filter": {
