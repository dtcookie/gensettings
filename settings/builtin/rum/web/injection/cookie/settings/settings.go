...
type Settings struct {
	...
	LinkActionsAndTraces     *string                 `json:"linkActionsAndTraces,omitempty"`  // Define a regular expression that matches the XHR calls to [link cross-origin XHR actions and their distributed traces](https://dt-url.net/en032ez). Dynatrace then adds the x-dtc header required for this type of correlation.
...
func (me *Settings) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"link_actions_and_traces": {
			Type:        schema.TypeString,
			Description: "Define a regular expression that matches the XHR calls to [link cross-origin XHR actions and their distributed traces](https://dt-url.net/en032ez). Dynatrace then adds the x-dtc header required for this type of correlation.",
			Optional:    true, // nullable
		},
...
func (me *Settings) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		...
		"link_actions_and_traces":     me.LinkActionsAndTraces,
