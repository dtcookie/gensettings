...
type DetectionCondition struct {
	...
	Property  ProcessItem `json:"property"`  // Possible Values: `CommandLine`, `Executable`, `ExecutablePath`
}
...
func (me *DetectionCondition) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"property": {
			Type:        schema.TypeString,
			Description: "Possible Values: `CommandLine`, `Executable`, `ExecutablePath`",
			Required:    true,
		},
	}
}
...
func (me *DetectionCondition) HandlePreconditions() {
}
