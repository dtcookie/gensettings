...
type SourceFilter struct {
	...
	SourceType   IngestDataSource `json:"sourceType"`             // Possible Values: `Metrics`, `Logs`, `Spans`, `Entities`, `Topology`, `Events`
}
...
func (me *SourceFilter) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Metrics`, `Logs`, `Spans`, `Entities`, `Topology`, `Events`",
			Required:    true,
		},
	}
}
