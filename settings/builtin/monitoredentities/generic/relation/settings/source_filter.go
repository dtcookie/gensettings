...
type SourceFilter struct {
	...
	SourceType   IngestDataSource `json:"sourceType"`             // Possible Values: `Events`, `Metrics`, `Logs`, `Spans`, `Entities`, `Topology`
}
...
func (me *SourceFilter) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Events`, `Metrics`, `Logs`, `Spans`, `Entities`, `Topology`",
			Required:    true,
		},
	}
}
