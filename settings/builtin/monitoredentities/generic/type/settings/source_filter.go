...
type SourceFilter struct {
	...
	SourceType IngestDataSource `json:"sourceType"`          // Possible Values: `Entities`, `Topology`, `Events`, `Metrics`, `Logs`, `Spans`
}
...
func (me *SourceFilter) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Entities`, `Topology`, `Events`, `Metrics`, `Logs`, `Spans`",
			Required:    true,
		},
	}
}
