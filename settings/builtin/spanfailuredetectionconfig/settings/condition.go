...
type Condition struct {
	...
	BoolComparisonType          *EnumSelectionsType           `json:"boolComparisonType,omitempty"`          // Possible Values: `NOT_ANY_OF`, `ONE_OF`
	...
	FloatValues                 []float64                     `json:"floatValues,omitempty"`                 // Any value from the list should match for the condition to be evaluated to true
	IntValue                    *int                          `json:"intValue,omitempty"`                    // Value
	IntValues                   []int                         `json:"intValues,omitempty"`                   // Any value from the list should match for the condition to be evaluated to true
	...
	Source                      SpanMatcherSource             `json:"source"`                                // Possible Values: `INSTRUMENTATION_SCOPE_NAME`, `INSTRUMENTATION_SCOPE_VERSION`, `RESOURCE_ATTRIBUTE`, `SPAN_ATTRIBUTE`, `SPAN_EVENT`, `SPAN_KIND`, `SPAN_NAME`, `SPAN_STATUS_CODE`, `SPAN_STATUS_MESSAGE`
	SourceKey                   *string                       `json:"sourceKey,omitempty"`                   // Key
	SpanKindValue               []SpanKind                    `json:"spanKindValue,omitempty"`               // Enable one or more status kinds.
	SpanStatusCodeValue         []SpanStatusCode              `json:"spanStatusCodeValue,omitempty"`         // Enable one or more status codes to be checked.
	StrValues                   []string                      `json:"strValues,omitempty"`                   // Any value from the list should match for the condition to be evaluated to true
...
func (me *Condition) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"bool_comparison_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `NOT_ANY_OF`, `ONE_OF`",
			Optional:    true, // precondition
		},
		"bool_value": {
			Type:        schema.TypeString,
		...
		"float_values": {
			Type:        schema.TypeSet,
			Description: "Any value from the list should match for the condition to be evaluated to true",
			Optional:    true, // precondition
		...
		"source": {
			Type:        schema.TypeString,
			Description: "Possible Values: `INSTRUMENTATION_SCOPE_NAME`, `INSTRUMENTATION_SCOPE_VERSION`, `RESOURCE_ATTRIBUTE`, `SPAN_ATTRIBUTE`, `SPAN_EVENT`, `SPAN_KIND`, `SPAN_NAME`, `SPAN_STATUS_CODE`, `SPAN_STATUS_MESSAGE`",
			Required:    true,
		},
		"source_key": {
			Type:        schema.TypeString,
		...
		"span_kind_value": {
			Type:        schema.TypeSet,
			Description: "Enable one or more status kinds.",
			Optional:    true, // precondition & minobjects == 0
			Elem:        &schema.Schema{Type: schema.TypeString},
		},
		"span_status_code_value": {
			Type:        schema.TypeSet,
			Description: "Enable one or more status codes to be checked.",
			Optional:    true, // precondition & minobjects == 0
			Elem:        &schema.Schema{Type: schema.TypeString},
		},
		"str_values": {
...
func (me *Condition) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		...
		"span_status_code_value":          me.SpanStatusCodeValue,
...
func (me *Condition) HandlePreconditions() error {
	...
	if me.BoolComparisonType == nil && slices.Contains([]string{"SPAN_KIND", "SPAN_STATUS_CODE"}, string(me.Source)) {
	...
	if me.SourceKey == nil && slices.Contains([]string{"SPAN_ATTRIBUTE", "RESOURCE_ATTRIBUTE"}, string(me.Source)) {
		return fmt.Errorf("'source_key' must be specified if 'source' is set to '%v'", me.Source)
	}
	if me.StringComparisonType == nil && !slices.Contains([]string{"SPAN_ATTRIBUTE", "SPAN_EVENT", "RESOURCE_ATTRIBUTE", "SPAN_KIND", "SPAN_STATUS_CODE"}, string(me.Source)) {
	...
	// ---- SpanStatusCodeValue []SpanStatusCode -> {"expectedValue":"SPAN_STATUS_CODE","property":"source","type":"EQUALS"}
	// ---- StrValues []string -> {"preconditions":[{"precondition":{"expectedValues":["SPAN_KIND","SPAN_ATTRIBUTE","SPAN_EVENT","RESOURCE_ATTRIBUTE","SPAN_STATUS_CODE"],"property":"source","type":"IN"},"type":"NOT"},{"preconditions":[{"precondition":{"expectedValues":["EXISTS","DOES_NOT_EXIST"],"property":"attrKeyStringComparisonType","type":"IN"},"type":"NOT"},{"expectedValue":"STRING","property":"dataType","type":"EQUALS"}],"type":"AND"}],"type":"OR"}
	return nil
}
