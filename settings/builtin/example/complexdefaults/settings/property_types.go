...
type PropertyTypess []*PropertyTypes

func (me *PropertyTypess) Schema() map[string]*schema.Schema {
...
func (me PropertyTypess) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeSlice("property_types_default", me)
}

func (me *PropertyTypess) UnmarshalHCL(decoder hcl.Decoder) error {
	return decoder.DecodeSlice("property_types_default", me)
}

type PropertyTypes struct {
	AnimalComplex   *AnimalComplex `json:"AnimalComplex"`   // Property type: `AnimalComplex`\n\nJava class: `java.lang.String`\n\nDefault constraints: -. Property type: `AnimalComplex`\n\nJava class: `java.lang.String`\n\nDefault constraints: -
...
func (me *PropertyTypes) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"animal_complex": {
			Type:        schema.TypeList,
			Description: "Property type: `AnimalComplex`\n\nJava class: `java.lang.String`\n\nDefault constraints: -. Property type: `AnimalComplex`\n\nJava class: `java.lang.String`\n\nDefault constraints: -",
			Required:    true,
...
func (me *PropertyTypes) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		"animal_complex":  me.AnimalComplex,
