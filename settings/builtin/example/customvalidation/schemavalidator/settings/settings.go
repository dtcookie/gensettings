...
type Settings struct {
	...
	UniqueCaseInsensitiveName string  `json:"uniqueCaseInsensitiveName"` // A unique (case-insensitive) name.
}
...
func (me *Settings) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"unique_case_insensitive_name": {
			Type:        schema.TypeString,
			Description: "A unique (case-insensitive) name.",
			Required:    true,
		},
	}
}
...
func (me *Settings) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		"scope":                        me.Scope,
		"unique_case_insensitive_name": me.UniqueCaseInsensitiveName,
	})
}
