...
type EventTemplate struct {
	...
	EventType   EventTypeEnum `json:"eventType"`            // Possible Values: `INFO`, `CUSTOM_ALERT`, `MARKED_FOR_TERMINATION`, `CUSTOM_ANNOTATION`, `CUSTOM_CONFIGURATION`, `CUSTOM_DEPLOYMENT`, `ERROR`, `AVAILABILITY`, `SLOWDOWN`, `RESOURCE`
...
func (me *EventTemplate) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"event_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `INFO`, `CUSTOM_ALERT`, `MARKED_FOR_TERMINATION`, `CUSTOM_ANNOTATION`, `CUSTOM_CONFIGURATION`, `CUSTOM_DEPLOYMENT`, `ERROR`, `AVAILABILITY`, `SLOWDOWN`, `RESOURCE`",
			Required:    true,
		},
		"metadata": {
