...
type Matcher struct {
	Attribute MatcherType `json:"attribute"` // Possible Values: `Dt_entity_process_group`, `Log_source`, `K8s_container_name`, `K8s_namespace_name`, `K8s_deployment_name`, `Container_name`, `Dt_entity_container_group`, `Process_technology`
...
func (me *Matcher) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"attribute": {
			...
			Description: "Possible Values: `Dt_entity_process_group`, `Log_source`, `K8s_container_name`, `K8s_namespace_name`, `K8s_deployment_name`, `Container_name`, `Dt_entity_container_group`, `Process_technology`",
			Required:    true,
		},
		"operator": {
			Type:        schema.TypeString,
