...
type EventAttributeComplex struct {
	...
	SourceType DataSourceWithStaticStringEnum `json:"sourceType"`       // Possible Values: `Constant_string`, `Request_method`, `Request_headers`, `Request_parameters`, `Response_body`, `Response_headers`, `Response_statusCode`, `Request_path`, `Request_body`
}
...
func (me *EventAttributeComplex) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Constant_string`, `Request_method`, `Request_headers`, `Request_parameters`, `Response_body`, `Response_headers`, `Response_statusCode`, `Request_path`, `Request_body`",
			Required:    true,
		},
	}
}
