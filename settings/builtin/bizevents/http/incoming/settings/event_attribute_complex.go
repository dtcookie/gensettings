...
type EventAttributeComplex struct {
	...
	SourceType DataSourceWithStaticStringEnum `json:"sourceType"`       // Possible Values: `Request_parameters`, `Request_body`, `Response_headers`, `Response_statusCode`, `Request_method`, `Request_headers`, `Constant_string`, `Request_path`, `Response_body`
}
...
func (me *EventAttributeComplex) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Request_parameters`, `Request_body`, `Response_headers`, `Response_statusCode`, `Request_method`, `Request_headers`, `Constant_string`, `Request_path`, `Response_body`",
			Required:    true,
		},
	}
}
