...
type EventDataAttributeComplex struct {
	...
	SourceType DataSourceWithStaticStringEnum `json:"sourceType"`       // Possible Values: `Request_path`, `Request_method`, `Request_headers`, `Request_body`, `Response_headers`, `Response_statusCode`, `Constant_string`, `Request_parameters`, `Response_body`
}
...
func (me *EventDataAttributeComplex) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source_type": {
			Type:        schema.TypeString,
			Description: "Possible Values: `Request_path`, `Request_method`, `Request_headers`, `Request_body`, `Response_headers`, `Response_statusCode`, `Constant_string`, `Request_parameters`, `Response_body`",
			Required:    true,
		},
	}
}
