...
type NicForm struct {
	...
	Os        OsTypeEnum `json:"os"`        // Possible Values: `OS_TYPE_DARWIN`, `OS_TYPE_HPUX`, `OS_TYPE_LINUX`, `OS_TYPE_SOLARIS`, `OS_TYPE_WINDOWS`, `OS_TYPE_ZOS`, `OS_TYPE_UNKNOWN`, `OS_TYPE_AIX`
}
...
func (me *NicForm) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"os": {
			Type:        schema.TypeString,
			Description: "Possible Values: `OS_TYPE_DARWIN`, `OS_TYPE_HPUX`, `OS_TYPE_LINUX`, `OS_TYPE_SOLARIS`, `OS_TYPE_WINDOWS`, `OS_TYPE_ZOS`, `OS_TYPE_UNKNOWN`, `OS_TYPE_AIX`",
			Required:    true,
		},
	}
}
