...
type ChartDefinition struct {
	ChartAsColumn     bool                   `json:"chartAsColumn"`        // If enabled, metric of that chart will generate table columns
	...
	DetailedChart     bool                   `json:"detailedChart"`        // If enabled, chart will be available in the expanded row of the entry in the table
...
func (me *ChartDefinition) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		"chart_as_column":     me.ChartAsColumn,
		"conditions":          me.Conditions,
		"detailed_chart":      me.DetailedChart,
