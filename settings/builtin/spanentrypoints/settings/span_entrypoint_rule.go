...
type SpanEntrypointRule struct {
	...
	RuleAction SpanEntrypointAction `json:"ruleAction"` // Possible Values: `DONT_CREATE_ENTRYPOINT`, `CREATE_ENTRYPOINT`
...
func (me *SpanEntrypointRule) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"rule_action": {
			...
			Description: "Possible Values: `DONT_CREATE_ENTRYPOINT`, `CREATE_ENTRYPOINT`",
			Required:    true,
		},
		"rule_name": {
			Type:        schema.TypeString,
