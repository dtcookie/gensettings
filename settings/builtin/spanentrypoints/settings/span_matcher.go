...
type SpanMatcher struct {
	...
	Source        SpanMatcherSource `json:"source"`                  // Possible Values: `SPAN_KIND`, `ATTRIBUTE`, `INSTRUMENTATION_SCOPE_NAME`, `INSTRUMENTATION_SCOPE_VERSION`, `SPAN_NAME`
...
func (me *SpanMatcher) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"source": {
			...
			Description: "Possible Values: `SPAN_KIND`, `ATTRIBUTE`, `INSTRUMENTATION_SCOPE_NAME`, `INSTRUMENTATION_SCOPE_VERSION`, `SPAN_NAME`",
			Required:    true,
		},
		"source_key": {
			Type:        schema.TypeString,
