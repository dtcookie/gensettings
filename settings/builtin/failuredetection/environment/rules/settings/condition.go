...
type Condition struct {
	Attribute Attributes `json:"attribute"` // Possible Values: `SERVICE_TYPE`, `SERVICE_TAG`, `PG_NAME`, `PG_TAG`, `SERVICE_MANAGEMENT_ZONE`, `SERVICE_NAME`
...
func (me *Condition) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"attribute": {
			...
			Description: "Possible Values: `SERVICE_TYPE`, `SERVICE_TAG`, `PG_NAME`, `PG_TAG`, `SERVICE_MANAGEMENT_ZONE`, `SERVICE_NAME`",
			Required:    true,
		},
		"predicate": {
